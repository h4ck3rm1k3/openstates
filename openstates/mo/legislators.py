...
class MOLegislatorScraper(LegislatorScraper):
    ...
    assumed_address_fmt = (
        '201 West Capitol Avenue %s, ' 'Jefferson City, MO 65101')
    ...
    def scrape_senators(self, chamber, session, term):
        ...
        for tr in table:
            ...
            party_and_district = tds[1].xpath(
                'div')[0].text_content().strip().split('-')
            ...
            senator_key = "%s%s" % (
                party_and_district[0].lower(), party_and_district[1])
            ...
            page = lxml.html.fromstring(details_page)
            address = page.xpath(
                '/html/body//span[2]')[0].text_content().split('\n')
    ...
    def scrape_reps(self, chamber, session, term):
        ...
        for tr in table.xpath('tr')[1:]:
            ...
            if last_name == 'Vacant':
                ...
                email = page.xpath(
                    '//*[@id="ContentPlaceHolder1_lblAddresses"]/table/tr[4]/td/a/@href')
                terms = page.xpath('//*[@id="ContentPlaceHolder1_lblElected"]')
                committees = page.xpath(
                    '//*[@id="ContentPlaceHolder1_lblCommittees"]/li/a')
                # TODO home address?
